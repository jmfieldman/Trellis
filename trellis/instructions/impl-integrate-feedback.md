...
- Does `overview.md` need an update too — module-tree, dependency-graph one-liner, sprint roster, feature-wide locked-decisions table? Do `decisions.md` or `status.md` need a new entry?
